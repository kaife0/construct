...
export function StoneCalculator({ rates }: { rates: MaterialRates }) {
  const m = useConcreteMix();
  const cost = m.result.aggregateCuft * rates.aggregatePerCuft;
    ...
    <div className="grid gap-8 lg:grid-cols-2 lg:gap-10">
      ...
      <ResultCard
        ...
        stats={[
          ...
          { label: "Rate used", value: `₹${rates.aggregatePerCuft}/cu.ft` },
        ]}
